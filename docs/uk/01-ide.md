...
![success-compilation](image56.png)

Після цього натисніть кнопку для завантаження прошивки:

![success-compilation](image8.png)
